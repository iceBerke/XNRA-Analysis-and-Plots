...
try:
    from xnra_uncertainty_v7 import (
        parse_xnra_full,
...
class XNRAViewerGUI:
    ...
    def create_uncertainty_tab_v6(self):
        ...
        # Results treeview with χ² and AUC columns
        columns = ('Layer', 'Element', 'Conc (%)', '± Stat', '± Q·Ω', '± σ', '± Total', 'ROI', 'χ²/ν', 'Status', 'AUC')
        ...
        col_widths = {
            ...
            'ROI': 60, 'χ²/ν': 50, 'Status': 55, 'AUC': 45
        }
