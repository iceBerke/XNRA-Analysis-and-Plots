...
RAW_MARKER_RANGE_MIN = 0               # set min value of channel range (included ?)
RAW_MARKER_RANGE_MAX = 200             # set max value of channel range (included ?)
...
SMOOTHED_MARKER_RANGE_MIN = 200         # set min value of channel range
SMOOTHED_MARKER_RANGE_MAX = 400         # set max value of channel range
...
def apply_marker_range(channels, counts, range_enabled, range_min, range_max):
    ...
    #mask = range_min <= channels <= range_max
