...
def process_single_file_v9(filepath: str,
                            ...
                            layers_to_include=None) -> List[Dict]:
    """
    ...
    layers_to_include : set or list of int, optional
        Layer numbers to include in the calculation. If None or empty,
    ...
    for roi in regions_of_interest:
        ...
        layer_filter = set(layers_to_include) if layers_to_include else None
        for layer in data['layers']:
            if layer_filter is not None and layer.get('layer_num') not in layer_filter:
                continue
